...
public class Score : MonoBehaviour
{
	...
	private EasyMovement playerControl;	// Reference to the player control script.
	...
	void Awake ()
	{
		...
		playerControl = GameObject.FindGameObjectWithTag("Player").GetComponent<EasyMovement>();
	}
